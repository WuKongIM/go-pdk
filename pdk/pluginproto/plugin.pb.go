...
var file_pdk_pluginproto_plugin_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x53, 0x65, 0x71, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6d, 0x65,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x3b, 0x70, 0x6c, 0x75, 0x67,
...
var file_pdk_pluginproto_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_pdk_pluginproto_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pdk_pluginproto_plugin_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pdk_pluginproto_plugin_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
